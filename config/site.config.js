...
module.exports = {
  ...
  googleFontLinks: ['https://fonts.googleapis.com/css2?family=Fira+Mono&family=Rajdhani:wght@500;600;700&display=swap'],

  // [OPTIONAL] The footer component of your website. You can write HTML here, but you need to escape double
  // quotes - changing " to \". You can write anything here, and if you like badges, generate some with https://shields.io
  footer:
    'Made by <a href="https://www.facebook.com/ZahidIUBAT" target="_blank" rel="noopener noreferrer">Zahid Hasan</a>.',
